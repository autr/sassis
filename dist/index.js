...
:root {
    ...
    function create_else_block(ctx) {
    	let each_1_anchor;
    	let each_value_1 = /*section*/ ctx[14].data;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*name, id, filtered, $params, html, className, window, isSearching*/ 127) {
    				each_value_1 = /*section*/ ctx[14].data;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_if_block$1(ctx) {
    	...
    	let td;
    	let span;
    	let t0_value = /*section*/ ctx[14].id + "";
    	let t0;
    	let t1;
    	let tr_id_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(td, "pt3", /*ii*/ ctx[16] > 0);
    			add_location(td, file$1, 55, 4, 1568);
    			attr_dev(tr, "id", tr_id_value = /*section*/ ctx[14].id);
    			attr_dev(tr, "class", "bb1-solid");
    			toggle_class(tr, "bt1-solid", /*ii*/ ctx[16] > 0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*filtered*/ 32 && t0_value !== (t0_value = /*section*/ ctx[14].id + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*filtered*/ 32 && tr_id_value !== (tr_id_value = /*section*/ ctx[14].id)) {
    ...
    function create_if_block_2(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[12](/*operator*/ ctx[17], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			span = element("span");
    			add_location(span, file$1, 77, 46, 2235);
    			attr_dev(a, "class", "w1em h1em b1-solid flex");
    			attr_dev(a, "href", a_href_value = `#/${/*name*/ ctx[0]}/${/*id*/ ctx[4](/*operator*/ ctx[17])}`);
    			toggle_class(a, "cross", /*$params*/ ctx[6].id == /*id*/ ctx[4](/*operator*/ ctx[17]));
    			add_location(a, file$1, 74, 8, 2091);
    			attr_dev(td, "class", "plr1 br1-solid pointer");
    			attr_dev(td, "width", "0px");
    			add_location(td, file$1, 71, 7, 1952);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*name, id, filtered*/ 49 && a_href_value !== (a_href_value = `#/${/*name*/ ctx[0]}/${/*id*/ ctx[4](/*operator*/ ctx[17])}`)) {
    				attr_dev(a, "href", a_href_value);
    			}

    			if (dirty & /*$params, id, filtered*/ 112) {
    				toggle_class(a, "cross", /*$params*/ ctx[6].id == /*id*/ ctx[4](/*operator*/ ctx[17]));
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_else_block_1(ctx) {
    	let span;
    	let raw_value = /*className*/ ctx[3](/*operator*/ ctx[17], /*section*/ ctx[14]) + "";

    	const block = {
    		c: function create() {
    			span = element("span");
    			add_location(span, file$1, 87, 8, 2422);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*className, filtered*/ 40 && raw_value !== (raw_value = /*className*/ ctx[3](/*operator*/ ctx[17], /*section*/ ctx[14]) + "")) span.innerHTML = raw_value;		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_1(ctx) {
    	let span;
    	let t_value = /*operator*/ ctx[17][0].join("\n") + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 85, 8, 2342);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*filtered*/ 32 && t_value !== (t_value = /*operator*/ ctx[17][0].join("\n") + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(span);
    		}
    ...
    function create_each_block_2(ctx) {
    	let div;
    	let raw_value = /*html*/ ctx[1](/*rule*/ ctx[20]) + "";

    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "rule");
    			add_location(div, file$1, 92, 8, 2575);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*html, filtered*/ 34 && raw_value !== (raw_value = /*html*/ ctx[1](/*rule*/ ctx[20]) + "")) div.innerHTML = raw_value;		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	};
    ...
    function create_each_block_1(ctx) {
    	...
    	let t2;
    	let tr_id_value;
    	let if_block0 = !/*isSearching*/ ctx[2] && create_if_block_2(ctx);

    	function select_block_type_1(ctx, dirty) {
    		if (/*section*/ ctx[14].raw) return create_if_block_1;
    		return create_else_block_1;
    	}

    	let current_block_type = select_block_type_1(ctx);
    	let if_block1 = current_block_type(ctx);
    	let each_value_2 = /*operator*/ ctx[17][1];
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(td0, "class", "br1-solid pl1");
    			add_location(td0, file$1, 83, 6, 2282);
    			attr_dev(td1, "class", "bright pl1 ");
    			add_location(td1, file$1, 90, 6, 2507);
    			attr_dev(tr, "id", tr_id_value = `/${/*name*/ ctx[0]}/${/*id*/ ctx[4](/*operator*/ ctx[17])}`);
    			attr_dev(tr, "class", "cptb1");
    			toggle_class(tr, "b2-solid", /*$params*/ ctx[6].id == /*id*/ ctx[4](/*operator*/ ctx[17]));
    			toggle_class(tr, "bt1-solid", /*i*/ ctx[19] > 0);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*html, filtered*/ 34) {
    				each_value_2 = /*operator*/ ctx[17][1];
    				validate_each_argument(each_value_2);
    				let i;
    			...
    			if (dirty & /*name, id, filtered*/ 49 && tr_id_value !== (tr_id_value = `/${/*name*/ ctx[0]}/${/*id*/ ctx[4](/*operator*/ ctx[17])}`)) {
    				attr_dev(tr, "id", tr_id_value);
    			}
    ...
    function create_each_block$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (!/*section*/ ctx[14].data) return create_if_block$1;
    ...
    function create_fragment$2(ctx) {
    	let t;
    	let table;
    	let if_block = /*filtered*/ ctx[5].length == 1 && /*filtered*/ ctx[5][0].data.length == 0 && create_if_block_3(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*filtered*/ ctx[5].length == 1 && /*filtered*/ ctx[5][0].data.length == 0) {
    				if (if_block) ; else {
    			...
    			if (dirty & /*filtered, name, id, $params, html, className, window, isSearching*/ 127) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const click_handler = (operator, e) => window.location = `#/${name}/${id(operator)}`;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("sanitise" in $$props) $$invalidate(9, sanitise = $$props.sanitise);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*html*/ 2) {
    			 $$invalidate(3, className = (operator, section) => {
    		...
    		if ($$self.$$.dirty & /*sanitise*/ 512) {
    			 $$invalidate(4, id = operator => `${sanitise(operator[0][0])}`);
    		}

    		if ($$self.$$.dirty & /*items*/ 256) {
    			 $$invalidate(2, isSearching = items != undefined);
    		}

    		if ($$self.$$.dirty & /*isSearching, items*/ 260) {
    			 $$invalidate(10, all = isSearching ? items : data.concat(fields));
    		}

    		if ($$self.$$.dirty & /*filters, all*/ 1152) {
    		...
    		if ($$self.$$.dirty & /*_filtered*/ 2048) {
    			 $$invalidate(5, filtered = _filtered());
    		}
    	};
    ...
    class ShorthandTable extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { name: 0, filters: 7, items: 8 });
    		...
    		if (/*items*/ ctx[8] === undefined && !("items" in props)) {
    ...
    function create_fragment$3(ctx) {
    	...
    	shorthandtable = new ShorthandTable({
    			props: {
    				filters: ["alignments", "spacer", "flex-basis", "example"],
    				name: "layouts"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div20, t4);
    			mount_component(shorthandtable, div20, null);
    			append_dev(div20, t5);
